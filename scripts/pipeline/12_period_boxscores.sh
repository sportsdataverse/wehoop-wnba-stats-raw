...
#
# Stage 12 of the WNBA stats raw pipeline. Every stage is independently
...
PYTHONUNBUFFERED=1 PYTHONIOENCODING=utf-8 "$PY" python/wnba_stats_03_period_boxscores.py "$SEASONS"
