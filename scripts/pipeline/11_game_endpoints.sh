...
#
# Stage 11 of the WNBA stats raw pipeline. Every stage is independently
...
PYTHONUNBUFFERED=1 PYTHONIOENCODING=utf-8 "$PY" python/wnba_stats_02_game_endpoints.py "$SEASONS"
