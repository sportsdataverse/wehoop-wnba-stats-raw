...
#
# Stage 40 of the WNBA stats raw pipeline. Every stage is independently
...
# The commit subject "WNBA Stats Raw Update (Start: YYYY End: YYYY)" is load-bearing
...
git add -- wnba_stats/wnba_stats_schedule_master.parquet \
           ...
           wnba_stats/wnba_stats_endpoint_coverage.parquet 2>/dev/null || true
