"""Thread-local sticky-session curl_cffi transport for the stats.wnba.com sweep.
...
Transient server-side 500s (stats.wnba.com intermittently 500s an individual
...
class SessionTransport:
    def __init__(self, rr, health, max_requests: int = 120, max_secs: float = 300.0):
        ...
        # stats.wnba.com 500s intermittently on individual historical games even
