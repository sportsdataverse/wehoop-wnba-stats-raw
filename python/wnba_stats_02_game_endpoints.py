#!/usr/bin/env python
"""Stage 02 — per-game whole-game payloads for stats.wnba.com.
...
for an old game -- it is out of scope, and the game still counts as complete.
    ...
    python python/wnba_stats_02_game_endpoints.py 2026
    python python/wnba_stats_02_game_endpoints.py 1996:2026
    python python/wnba_stats_02_game_endpoints.py --game-ids=ids.txt
    python python/wnba_stats_02_game_endpoints.py --check 2026
"""
