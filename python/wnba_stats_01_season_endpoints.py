#!/usr/bin/env python
"""Stage 01 — season-level payloads for stats.wnba.com.
...
empty payload would block its own refetch forever -- see stage 20).
    ...
    python python/wnba_stats_01_season_endpoints.py 2026
    python python/wnba_stats_01_season_endpoints.py 1996:2026
    python python/wnba_stats_01_season_endpoints.py --check 2026   # size it, fetch nothing
"""
...
from wnba_stats_raw_scrape._capture_runtime import (  # noqa: E402
    ENDPOINT_MIN_SEASON,
    LEAGUE_ID,
    STATS_PREFIX,
    _log,
...
def main(argv: list[str]) -> int:
    ...
    from wnba_stats_raw_scrape.endpoints import plan_counts  # noqa: E402
    from wnba_stats_raw_scrape.season_capture import capture_season  # noqa: E402
