#!/usr/bin/env python
"""Stage 03 — per-period boxscores for stats.wnba.com.
...
unknowable, and stage 02 is the thing that owes it a playbyplayv3.
    ...
    python python/wnba_stats_03_period_boxscores.py 2026
    python python/wnba_stats_03_period_boxscores.py --game-ids=ids.txt
    python python/wnba_stats_03_period_boxscores.py --check 2026
"""
